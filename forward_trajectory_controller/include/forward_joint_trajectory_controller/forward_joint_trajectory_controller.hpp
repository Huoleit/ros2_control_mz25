#ifndef FORWARD_JOINT_TRAJECTORY_CONTROLLER__JOINT_TRAJECTORY_CONTROLLER_HPP_
#define FORWARD_JOINT_TRAJECTORY_CONTROLLER__JOINT_TRAJECTORY_CONTROLLER_HPP_
...
#include "forward_joint_trajectory_controller/tolerances.hpp"
...
class ForwardJointTrajectoryController : public controller_interface::ControllerInterface
{
public:
  FORWARD_JOINT_TRAJECTORY_CONTROLLER_PUBLIC
  ForwardJointTrajectoryController();
