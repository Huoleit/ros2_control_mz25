#include "forward_joint_trajectory_controller/forward_joint_trajectory_controller.hpp"
...
ForwardJointTrajectoryController::ForwardJointTrajectoryController()
: controller_interface::ControllerInterface(),
  joint_names_({})
{}

controller_interface::return_type
ForwardJointTrajectoryController::init(const std::string & controller_name)
{
...
controller_interface::InterfaceConfiguration ForwardJointTrajectoryController::
...
controller_interface::return_type
ForwardJointTrajectoryController::update()
{
...
ForwardJointTrajectoryController::on_configure(const rclcpp_lifecycle::State &)
{
  ...
  action_server_ = rclcpp_action::create_server<FollowJTrajAction>(
    ...
    std::bind(&ForwardJointTrajectoryController::goal_callback, this, _1, _2),
    std::bind(&ForwardJointTrajectoryController::cancel_callback, this, _1),
    std::bind(&ForwardJointTrajectoryController::feedback_setup_callback, this, _1)
  );
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn
ForwardJointTrajectoryController::on_activate(const rclcpp_lifecycle::State &)
{
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn
ForwardJointTrajectoryController::on_deactivate(const rclcpp_lifecycle::State &)
{
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn
ForwardJointTrajectoryController::on_cleanup(const rclcpp_lifecycle::State &)
{
  // go home
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn
ForwardJointTrajectoryController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset()) {
    return rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::ERROR;
  }
...
bool
ForwardJointTrajectoryController::reset()
{
  subscriber_is_active_ = false;
...
rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn
ForwardJointTrajectoryController::on_shutdown(const rclcpp_lifecycle::State &)
{
...
void
ForwardJointTrajectoryController::halt()
{
...
void ForwardJointTrajectoryController::publish_state(
...
rclcpp_action::GoalResponse ForwardJointTrajectoryController::goal_callback(
...
rclcpp_action::CancelResponse ForwardJointTrajectoryController::cancel_callback(
...
void ForwardJointTrajectoryController::feedback_setup_callback(
...
void ForwardJointTrajectoryController::fill_partial_goal(
...
void ForwardJointTrajectoryController::sort_to_local_joint_order(
...
bool ForwardJointTrajectoryController::validate_trajectory_point_field(
...
bool ForwardJointTrajectoryController::validate_trajectory_msg(
...
void ForwardJointTrajectoryController::add_new_trajectory_msg(
  const std::shared_ptr<trajectory_msgs::msg::JointTrajectory> & traj_msg)
{
  traj_msg_external_point_ptr_.writeFromNonRT(traj_msg);
}

void ForwardJointTrajectoryController::preempt_active_goal()
{
  if (rt_active_goal_) {
    auto action_res = std::make_shared<FollowJTrajAction::Result>();
...
void ForwardJointTrajectoryController::set_hold_position()
{
...
PLUGINLIB_EXPORT_CLASS(
  forward_joint_trajectory_controller::ForwardJointTrajectoryController, controller_interface::ControllerInterface)
